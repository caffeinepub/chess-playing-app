...
import type { ExternalBlob as _ExternalBlob, Post as _Post, SocialProfile as _SocialProfile, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async countFollowers(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countFollowers(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async countFollowing(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countFollowing(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createComment(arg0: string, arg1: string, arg2: string): Promise<Comment> {
        if (this.processError) {
            try {
    ...
    async createPost(arg0: string, arg1: ExternalBlob): Promise<Post> {
        if (this.processError) {
            try {
    ...
    async createProfile(arg0: string, arg1: string, arg2: ExternalBlob): Promise<SocialProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.createProfile(arg0, arg1, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg2));
                return from_candid_SocialProfile_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getCommentsByPostId(arg0: string): Promise<Array<Comment>> {
        if (this.processError) {
            try {
    ...
    async getPostById(arg0: string): Promise<Post> {
        if (this.processError) {
            try {
    ...
    async getProfileById(arg0: string): Promise<SocialProfile> {
        if (this.processError) {
            try {
    ...
    async getSelfProfile(): Promise<SocialProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getSelfProfile();
                return from_candid_SocialProfile_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listProfiles(arg0: string | null): Promise<Array<SocialProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.listProfiles(to_candid_opt_n22(this._uploadFile, this._downloadFile, arg0));
    ...
    async toggleLike(arg0: string): Promise<Post> {
        if (this.processError) {
            try {
    ...
    async updateProfile(arg0: string, arg1: string, arg2: ExternalBlob): Promise<SocialProfile> {
        if (this.processError) {
            try {
...
async function from_candid_Post_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Post): Promise<Post> {
    return await from_candid_record_n12(_uploadFile, _downloadFile, value);
}
async function from_candid_SocialProfile_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SocialProfile): Promise<SocialProfile> {
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Post>): Promise<Array<Post>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Post_n11(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SocialProfile>): Promise<Array<SocialProfile>> {
    return await Promise.all(value.map(async (x)=>await from_candid_SocialProfile_n14(_uploadFile, _downloadFile, x)));
}
